  ...
  return (
    <Card className="group overflow-hidden relative">
      <CardHeader className="p-0">
        ...
        <div className="relative w-full h-[300px] flex items-center justify-center bg-tertiary dark:bg-secondary/40 xl:bg-work_project_bg_light xl:dark:bg-work_project_bg_dark xl:bg-[110%] xl:bg-no-repeat overflow-hidden">
          ...
          <div className="flex gap-x-4">
            ...
            <Link
              href={project.github}
              className="bg-secondary w-[54px] h-[54px] rounded-full flex justify-center items-center scale-0 opacity-0 group-hover:scale-100 group-hover:opacity-100 transition-all duration-300 ease-in-out"
            >
      ...
      <div className="h-full px-8 py-6">
        ...
        <h4 className="h4 mb-1 dark:text-white">{project.name}</h4>
